...
public class proyecto {
    public static void main(String[] args) {
        ...
        int  num;
        num = Integer.parseInt(JOptionPane.showInputDialog(null,"Por favor ingrese la cantidad de estudiantes"));
        ...
        if (conteo_igual == 5){
            ...
            System.out.println(" niños edad igual a 5 años son: " + conteo_igual);
        }
        if (conteo_mayor == 5){
            System.out.println(" no se puede calcular la cantidad de niños que son menores de 5 años");
        }
        else {
            promedio = suma_mayor / conteo_mayor;
            System.out.println("El promedio de niños que son mayores a 5 son: " + promedio);
